...
export default function German() {
  ...
  const germanArticles = articles.filter(article => article.fields.name.includes("German"))

  const germanArticlesList = germanArticles.map((article, index) =>
 ...
 <div>
  ...
  // console.log("germanArticles", germanArticles)
