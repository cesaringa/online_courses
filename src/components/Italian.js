...
import { Card, ListGroup, ListGroupItem, Badge, Form, Row,Col, Button, CardGroup, Placeholder, FloatingLabel } from 'react-bootstrap'
...
export default function Italian() {
  ...
  const italianArticles = articles.filter(article => article.fields.name.includes("Italian"))

  const italianArticlesList = italianArticles.map((article, index) =>
 ...
 <div>
  ...
  // console.log("italianArticles", italianArticles)
